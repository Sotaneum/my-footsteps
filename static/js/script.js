...
const MENU_ADD_POST_FROM_MAP = $.jsMenu.item.create("./static/images/map.png","추가/수정",function(){
    SETMODIFYMODE(MENU_ADD_POST_FROM_MAP);
}).setWidth(90).setHeight(100);

const MENU_ADD_POST_FROM_TEXT = $.jsMenu.item.create("./static/images/text.png","삭제",function(){
